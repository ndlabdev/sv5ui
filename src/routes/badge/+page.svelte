...
<div class="space-y-8">
	...
	<section class="space-y-3">
		...
		<div class="flex flex-wrap gap-2 rounded-lg bg-surface-container-high p-4">
			...
			<Badge label="Info" leadingIcon="lucide:info" trailingIcon="lucide:chevron-right" color="info" />
		</div>
	</section>
	...
	<section class="space-y-3">
		...
		<div class="flex flex-wrap gap-2 rounded-lg bg-surface-container-high p-4">
			...
			<Badge label="Jane" avatar={{ alt: 'Jane', src: 'https://i.pravatar.cc/32?u=2' }} color="secondary" />
			<Badge label="Admin" avatar={{ alt: 'Admin' }} color="tertiary" variant="soft" size="lg" />
		</div>
	</section>
			...
			<table class="w-full">
				<thead>
					<tr class="border-b border-outline-variant">
						<th class="px-3 py-3 text-left text-sm font-medium text-on-surface-variant">Variant</th>
						{#each colors as color}
							<th class="px-3 py-3 text-center text-sm font-medium text-on-surface-variant capitalize">{color}</th>
						{/each}
					</tr>
				</thead>
				<tbody>
					{#each variants as variant}
						<tr class="border-b border-outline-variant/50">
							<td class="px-3 py-3 text-sm font-medium text-on-surface-variant">{variant}</td>
							{#each colors as color}
	...
	<section class="space-y-3">
		...
		<div class="flex flex-wrap gap-2 rounded-lg bg-surface-container-high p-4">
			<Badge
				label="Rounded Full"
				ui={{ base: 'rounded-full px-3' }}
			/>
			<Badge
				label="Custom"
				ui={{ base: 'bg-gradient-to-r from-primary to-tertiary text-on-primary rounded-full px-3' }}
			/>
			<Badge
				label="Bold"
	...
	<section class="space-y-3">
		...
		<div class="space-y-6 rounded-lg bg-surface-container-high p-4">
			...
			<div class="space-y-2">
				...
				<div class="max-w-sm rounded-lg border border-outline-variant bg-surface-container p-4">
