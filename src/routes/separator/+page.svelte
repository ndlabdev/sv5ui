<script lang="ts">
	...
	const colors = ['surface', 'primary', 'secondary', 'tertiary', 'success', 'warning', 'error', 'info'] as const
	...
	<section class="space-y-3">
		...
		<div class="space-y-4 rounded-lg bg-surface-container-high p-4">
			...
			<Separator color="secondary">
				{#snippet content()}
					<span class="rounded-full bg-secondary-container px-3 py-1 text-xs text-on-secondary-container">
						New messages
					</span>
				{/snippet}
			</Separator>
			...
			<table class="w-full">
				<thead>
					<tr class="border-b border-outline-variant">
						...
						{#each sizes as size}
							<th class="px-3 py-3 text-left text-sm font-medium text-on-surface-variant">{size}</th>
						{/each}
					</tr>
				</thead>
				<tbody>
	...
	<section class="space-y-3">
		...
		<div class="space-y-4 rounded-lg bg-surface-container-high p-4">
			...
			<Separator
				...
				ui={{ border: 'bg-gradient-to-r from-primary via-secondary to-tertiary h-0.5 border-none' }}
			/>
		</div>
	</section>
</div>
