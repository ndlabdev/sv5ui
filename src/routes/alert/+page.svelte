...
<div class="space-y-8">
	...
	<section class="space-y-3">
		...
		<div class="space-y-3 rounded-lg bg-surface-container-high p-4">
			<Alert color="info" icon="lucide:info" title="Information" description="This alert includes an icon for visual emphasis." />
			<Alert color="success" icon="lucide:check-circle" title="Success" description="Your changes have been saved." />
			<Alert color="warning" icon="lucide:alert-triangle" title="Warning" description="Your session will expire in 5 minutes." />
			<Alert color="error" icon="lucide:x-circle" title="Error" description="Failed to connect to server." />
		</div>
	</section>
	...
	<section class="space-y-3">
		...
		<div class="space-y-3 rounded-lg bg-surface-container-high p-4">
			<Alert icon="lucide:bell" title="Notification" description="You have 3 new messages." close />
			<Alert color="warning" icon="lucide:alert-triangle" title="Dismissible Warning" description="This alert can be dismissed." close />
		</div>
	</section>
