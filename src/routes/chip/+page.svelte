...
<div class="space-y-8">
	...
	<section class="space-y-3">
		...
		<p class="text-sm text-on-surface-variant">
			Control visibility with the <code class="rounded bg-surface-container-highest px-1">show</code> prop.
		</p>
		<div class="flex flex-wrap items-center gap-8 rounded-lg bg-surface-container-high p-4">
			<div class="flex flex-col items-center gap-2">
			...
			<table class="w-full">
				<thead>
					<tr class="border-b border-outline-variant">
						...
						{#each positions as position}
							<th class="px-3 py-3 text-center text-sm font-medium text-on-surface-variant">{position}</th>
						{/each}
					</tr>
				</thead>
				<tbody>
