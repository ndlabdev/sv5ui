...
<div class="space-y-8">
	<div class="space-y-2">
		...
		<p class="text-on-surface-variant">
			Display empty state UI when there's no content to show, with support for icons, avatars, and action buttons.
		</p>
	</div>
	...
	<section class="space-y-3">
		...
		<div class="grid gap-3 rounded-lg bg-surface-container-high p-4 sm:grid-cols-2">
			<Empty variant="solid" icon="lucide:inbox" title="Solid" description="Filled background style" />
			<Empty variant="outline" icon="lucide:inbox" title="Outline" description="Border with transparent background" />
			<Empty variant="soft" icon="lucide:inbox" title="Soft" description="Light colored background" />
			<Empty variant="subtle" icon="lucide:inbox" title="Subtle" description="Light background with border" />
		</div>
	</section>
	...
	<section class="space-y-3">
		...
		<div class="grid gap-3 rounded-lg bg-surface-container-high p-4 sm:grid-cols-2 lg:grid-cols-4">
	...
	<section class="space-y-3">
		...
		<div class="space-y-3 rounded-lg bg-surface-container-high p-4">
			...
			<Empty size="xl" icon="lucide:inbox" title="Extra Large" description="Extra large size" />
		</div>
	</section>
	...
	<section class="space-y-3">
		...
		<div class="space-y-3 rounded-lg bg-surface-container-high p-4">
			...
			<Empty
				...
				actions={[
				    { label: 'Start Shopping', color: 'warning', leadingIcon: 'lucide:shopping-bag' }
				]}
			/>
			...
			<Empty
				...
				actions={[
				    { label: 'Retry', color: 'error', leadingIcon: 'lucide:refresh-cw' }
				]}
			/>
	...
	<section class="space-y-3">
		...
		<div class="rounded-lg bg-surface-container-high p-4">
			<Empty variant="outline" color="tertiary">
				{#snippet leading()}
					<div class="flex size-16 items-center justify-center rounded-full bg-tertiary/10 text-tertiary">
				...
				{#snippet actionsSlot()}
					<div class="flex flex-wrap gap-2">
						<button class="rounded-md bg-tertiary px-4 py-2 text-sm font-medium text-on-tertiary hover:bg-tertiary/90">
							Get Started
						</button>
						<button class="rounded-md px-4 py-2 text-sm font-medium text-on-surface-variant hover:bg-surface-container-highest">
							Learn More
						</button>
					</div>
				{/snippet}
