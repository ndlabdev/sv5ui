	...
	<section class="space-y-3">
		...
		<div class="space-y-6 rounded-lg bg-surface-container-high p-4">
			...
			<div class="space-y-2">
				...
				<div class="flex items-center gap-2 rounded-lg border border-outline-variant bg-surface-container p-3">
			...
			<div class="space-y-2">
				...
				<div class="max-w-xs rounded-lg border border-outline-variant bg-surface-container">
					<div class="flex items-center justify-between px-3 py-2 hover:bg-surface-container-high">
