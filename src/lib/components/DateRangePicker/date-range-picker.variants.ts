...
export const dateRangePickerVariants = tv({
    slots: {
        ...
        field: [
            ...
            'has-data-disabled:cursor-not-allowed has-data-disabled:opacity-75',
            'has-data-invalid:ring-error',
            'transition-colors',
            'focus-within:outline-none'
        ],
        input: 'flex items-center whitespace-nowrap',
        separator: 'shrink-0 text-on-surface-variant/75',
        segment: [
...
export type DateRangePickerSlots = keyof ReturnType<typeof dateRangePickerVariants>

export const dateRangePickerDefaults = {
    defaultVariants: dateRangePickerVariants.defaultVariants,
    slots: {} as Partial<Record<DateRangePickerSlots, string>>
}
